                        ...
                        <div class="card">
                            ...
                            <form action="RegisterServlet" method="POST">
                                <div class="card-header text-center primary-background text-white">
                                    <h1 class="d-flex flex-column"><i class="fa-solid fa-circle-user"></i> Register Now
                                    </h1>
                                ...
                                <div class="card-body text-white" style="background-color:#8b7fe7">
                                    ...
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="checkbx" name="check"
                                            value="check">
                                        <label class="form-check-label" for="checkgx">I agree to terms and
                                            condition</label>
                                    </div>
                                </div>
